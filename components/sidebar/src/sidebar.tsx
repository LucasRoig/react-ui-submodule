...
import { Separator } from "@lro-ui/separator";
import { Sheet, SheetContent, SheetDescription, SheetHeader, SheetTitle } from "@lro-ui/sheet";
import { Skeleton } from "@lro-ui/skeleton";
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from "@lro-ui/tooltip";
import { cn, useIsMobile } from "@lro-ui/utils";
import { Slot } from "@radix-ui/react-slot";
import { PanelLeftIcon } from "lucide-react";
/**
 * Using this component requires adding some variables inside your css.
...
function SidebarTrigger({ className, onClick, ...props }: React.ComponentProps<typeof Button>) {
  ...
  return (
    <Button
      ...
      // variant="ghost" //TODO : we should probably add this to the button component
      // size="icon"
...
const sidebarMenuButtonVariants = tv({
  base: `peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2
